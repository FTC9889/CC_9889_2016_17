...
import static org.firstinspires.ftc.teamcode.OffSeason.Code.Subsystems.Working.Drivebase.DriveWithGyro.*;

/**
 * Created by joshua on 3/8/17.
 */
@Autonomous(name = "Offseason Red", group = "Auton")
public class Team9889_Red_Side extends Team9889OpMode{
    ...
    private int state = Drivetrain.AutonState;
    ...
    public void loop(){
        ...
        switch (Drivetrain.AutonState){
            ...
            case 1:
                ...
                break;
            case 2:
                Drivetrain.DriveWithGyro(ToWhiteLine, 0, -0.15, Drivetrain);
                break;
            case 3:
                ...
                break;
            case 4:
                Drivetrain.Drive(Drivebase.Drive.StraightWithPower, -0.1, 0.0, Drivebase.DrivetrainSide.Left, 700, runtime.milliseconds(), true);
                break;
            case 5:
